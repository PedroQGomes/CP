...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{rrot}\mathbin{::}(\Conid{Eq}\;\Varid{a})\Rightarrow \fun{BTree} \;\Varid{a}\to \fun{BTree} \;\Varid{a}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{discollect}\;((\Varid{a},\Varid{x})\mathbin{:}\Varid{y})\mathrel{=}[\mskip1.5mu (\Varid{a},\Varid{b})\mid \Varid{b}\leftarrow \Varid{x}\mskip1.5mu]\plus \Varid{discollect}\;\Varid{y}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\Varid{l}}{\Varid{f}}{}\<[E]%
\\
\>[3]{}\hsindent{4}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{l}\;\Varid{v}\mathrel{=}[\mskip1.5mu ([\mskip1.5mu \mskip1.5mu],\Varid{v})\mskip1.5mu]{}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{f}\;(\Varid{t},\Varid{ts})\mathrel{=}\map \;((\Varid{t}\plus )\times\Varid{id})\;(\Varid{concat}\;\Varid{ts}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment procurar traducoes para uma determinada palavra}{}\<[E]%
\\
\>[B]{}\Varid{dic\char95 rd}\mathbin{::}\Conid{String}\to \Conid{Dict}\to \Conid{Maybe}\;[\mskip1.5mu \Conid{String}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{dic\char95 rd}\;\Varid{s}\;\Varid{disc}\mathrel{=}\Varid{auxTraduc}\;\Varid{s}\;(\Varid{dic\char95 exp}\;\Varid{disc}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxTraduc}\mathbin{::}\Conid{String}\to [\mskip1.5mu (\Conid{String},[\mskip1.5mu \Conid{String}\mskip1.5mu])\mskip1.5mu]\to \Conid{Maybe}\;[\mskip1.5mu \Conid{String}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{auxTraduc}\;\Varid{s}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{Nothing}{}\<[E]%
\\
\>[B]{}\Varid{auxTraduc}\;\Varid{s}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}\mathbf{if}\;(\Varid{s}\equiv (\p1\;(\Varid{h})))\;\mathbf{then}\;\Conid{Just}\;(\p2\;\Varid{h})\;\mathbf{else}\;\Varid{auxTraduc}\;\Varid{s}\;\Varid{t}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  inserir palavras novas (palavra e traduc¸ao)}{}\<[E]%
\\
\>[B]{}\Varid{dic\char95 in}\mathbin{::}\Conid{String}\to \Conid{String}\to \Conid{Dict}\to \Conid{Dict}{}\<[E]%
\\
\>[B]{}\Varid{dic\char95 in}\;\Varid{p}\;\Varid{t}\;\Varid{disc}\mathrel{=}\Varid{dic\char95 imp}\;(\Varid{inserePalavra}\;\Varid{p}\;\Varid{t}\;(\Varid{dic\char95 exp}\;\Varid{disc})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inserePalavra}\mathbin{::}\Conid{String}\to \Conid{String}\to [\mskip1.5mu (\Conid{String},[\mskip1.5mu \Conid{String}\mskip1.5mu])\mskip1.5mu]\to [\mskip1.5mu (\Conid{String},[\mskip1.5mu \Conid{String}\mskip1.5mu])\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{inserePalavra}\;\Varid{p}\;\Varid{t}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu (\Varid{p},[\mskip1.5mu \Varid{t}\mskip1.5mu])\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{inserePalavra}\;\Varid{p}\;\Varid{s}\;(\Varid{h}\mathbin{:}\Varid{t})\mid \Varid{p}\equiv \p1\;(\Varid{h})\mathrel{=}(\Varid{p},\Varid{sort}\;((\p2\;\Varid{h})\plus [\mskip1.5mu \Varid{s}\mskip1.5mu]))\mathbin{:}\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mid \Varid{p}\mathbin{<}\p1\;(\Varid{h})\mathrel{=}(\Varid{p},[\mskip1.5mu \Varid{s}\mskip1.5mu])\mathbin{:}\Varid{h}\mathbin{:}\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mid \Varid{otherwise}\mathrel{=}\Varid{h}\mathbin{:}\Varid{inserePalavra}\;\Varid{p}\;\Varid{s}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment maisDir :: BTree a -> Maybe a}{}\<[E]%
\\
\>[B]{}\Varid{maisDir}\mathrel{=}\Varid{cataBTree}\;\alt{\underline{\Conid{Nothing}}}{\Varid{g2}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{g2}\;(\Varid{v},(\anonymous ,\Conid{Nothing}))\mathrel{=}\Conid{Just}\;\Varid{v}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{g2}\;(\Varid{v},(\Varid{l},\Varid{r}))\mathrel{=}\Varid{r}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment maisEsq :: BTree a -> Maybe a}{}\<[E]%
\\
\>[B]{}\Varid{maisEsq}\mathrel{=}\Varid{cataBTree}\;\alt{\underline{\Conid{Nothing}}}{\Varid{f}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\Varid{f}\;(\Varid{a},(\Conid{Nothing},\anonymous ))\mathrel{=}\Conid{Just}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\Varid{f}\;(\Varid{a},(\Varid{t1},\Varid{t2}))\mathrel{=}\Varid{t1}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment insOrd' :: (Ord a) => a -> BTree a -> (BTree a, BTree a)}{}\<[E]%
\\
\>[B]{}\Varid{insOrd'}\;\Varid{x}\mathrel{=}\Varid{cataBTree}\;\alt{\Varid{g1}}{\Varid{g2}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{g1}\mathrel{=}\bot {}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{g2}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment insOrd :: (Ord a) => a -> BTree a -> BTree a}{}\<[E]%
\\
\>[B]{}\Varid{insOrd}\;\Varid{a}\;\Varid{x}\mathrel{=}\Varid{anaBTree}\;\Varid{g}\;(\Conid{Just}\;\Varid{a},\Varid{x}){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{g}\;(\Conid{Nothing},\Conid{Empty})\mathrel{=}i_1\;(){}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{g}\;(\Conid{Just}\;\Varid{a},\Conid{Empty})\mathrel{=}i_2\;(\Varid{a},((\Conid{Nothing},\Conid{Empty}),(\Conid{Nothing},\Conid{Empty}))){}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{g}\;(\Conid{Nothing},\Conid{Node}\;(\Varid{r},(\Varid{l},\Varid{d})))\mathrel{=}i_2\;(\Varid{r},((\Conid{Nothing},\Varid{l}),(\Conid{Nothing},\Varid{d}))){}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{g}\;(\Conid{Just}\;\Varid{a},\Conid{Node}\;(\Varid{r},(\Varid{l},\Varid{d}))){}\<[45]%
\>[45]{}\mid \Varid{a}\leq \Varid{r}\mathrel{=}i_2\;(\Varid{r},((\Conid{Just}\;\Varid{a},\Varid{l}),(\Conid{Nothing},\Varid{d}))){}\<[E]%
\\
\>[45]{}\mid \Varid{otherwise}\mathrel{=}i_2\;(\Varid{r},((\Conid{Nothing},\Varid{l}),(\Conid{Just}\;\Varid{a},\Varid{l}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment isOrd' :: (Ord a) => BTree a -> (Bool, BTree a)}{}\<[E]%
\\
\>[B]{}\Varid{isOrd'}\mathrel{=}\Varid{cataBTree}\;\alt{\Varid{g1}}{\Varid{g2}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g1}\;\Varid{a}\mathrel{=}\bot {}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;\Varid{a}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment isOrd :: (Ord a) => BTree a -> Bool}{}\<[E]%
\\
\>[B]{}\Varid{isOrd}\;\Conid{Empty}\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{isOrd}\;(\Conid{Node}\;(\Varid{a},(\Conid{Empty},\Conid{Empty})))\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{isOrd}\;(\Conid{Node}\;(\Varid{a},(\Conid{Node}\;(\Varid{e},(\Varid{l},\Varid{d})),\Conid{Empty})))\mathrel{=}\mathbf{if}\;\Varid{e}\leq \Varid{a}\;\mathbf{then}\;\Varid{isOrd}\;(\Conid{Node}\;(\Varid{e},(\Varid{l},\Varid{d})))\;\mathbf{else}\;\Conid{False}{}\<[E]%
\\
\>[B]{}\Varid{isOrd}\;(\Conid{Node}\;(\Varid{a},(\Conid{Empty},\Conid{Node}\;(\Varid{rd},(\Varid{l},\Varid{d})))))\mathrel{=}\mathbf{if}\;\Varid{a}\mathbin{<}\Varid{rd}\;\mathbf{then}\;\Varid{isOrd}\;(\Conid{Node}\;(\Varid{rd},(\Varid{l},\Varid{d})))\;\mathbf{else}\;\Conid{False}{}\<[E]%
\\
\>[B]{}\Varid{isOrd}\;(\Conid{Node}\;(\Varid{a},(\Conid{Node}\;(\Varid{re},(\Varid{ee},\Varid{ed})),\Conid{Node}\;(\Varid{rd},(\Varid{de},\Varid{dd})))))\mathrel{=}\mathbf{if}\;\Varid{a}\mathbin{<}\Varid{rd}\mathrel{\wedge}\Varid{re}\leq \Varid{a}\;\mathbf{then}\;\Varid{isOrd}\;(\Conid{Node}\;(\Varid{re},(\Varid{ee},\Varid{ed})))\mathrel{\wedge}\Varid{isOrd}\;(\Conid{Node}\;(\Varid{rd},(\Varid{de},\Varid{dd})))\;\mathbf{else}\;\Conid{False}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment rrot :: BTree a -> BTree a}{}\<[E]%
\\
\>[B]{}\Varid{rrot}\mathrel{=}\Varid{cataBTree}\;\alt{\Varid{g1}}{\Varid{g2}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{g1}\;\Varid{a}\mathrel{=}\Conid{Empty}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{g2}\;(\Varid{r},(\Conid{Empty},\Conid{Empty}))\mathrel{=}\Conid{Node}\;(\Varid{r},(\Conid{Empty},\Conid{Empty})){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{g2}\;(\Varid{r},(\Conid{Empty},\Varid{d}))\mathrel{=}\Conid{Node}\;(\Varid{r},(\Conid{Empty},\Varid{d})){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{g2}\;(\Varid{r},(\Conid{Node}\;(\Varid{e},(\Varid{ee},\Varid{dir})),\Varid{d}))\mid \Varid{r}\equiv \Varid{e}\mathrel{=}\Conid{Node}\;(\Varid{r},(\Conid{Node}\;(\Varid{e},(\Varid{ee},\Varid{dir})),\Varid{d})){}\<[E]%
\\
\>[6]{}\hsindent{28}{}\<[34]%
\>[34]{}\mid \Varid{otherwise}\mathrel{=}\Conid{Node}\;(\Varid{e},(\Varid{ee},\Conid{Node}\;(\Varid{r},(\Varid{dir},\Varid{d})))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment lrot :: BTree a -> BTree a}{}\<[E]%
\\
\>[B]{}\Varid{lrot}\mathrel{=}\Varid{cataBTree}\;\alt{\Varid{g1}}{\Varid{g2}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{g1}\;\Varid{a}\mathrel{=}\Conid{Empty}{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{g2}\;(\Varid{r},(\Varid{l},\Conid{Empty}))\mathrel{=}\Conid{Node}\;(\Varid{r},(\Varid{l},\Conid{Empty})){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{g2}\;(\Varid{r},(\Varid{l},\Conid{Node}\;(\Varid{d},(\Varid{e},\Varid{dd}))))\mathrel{=}\Conid{Node}\;(\Varid{d},(\Conid{Node}\;(\Varid{r},(\Varid{l},\Varid{e})),\Varid{dd})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment splay :: [Bool] -> (BTree a -> BTree a)}{}\<[E]%
\\
\>[B]{}\Varid{splay}\mathrel{=}\Varid{flip}\;(\Varid{cataBTree}\;\alt{\Varid{g1}}{\Varid{g2}})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{g1}\;\Varid{a}\;\anonymous \mathrel{=}\Conid{Empty}{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{g2}\;(\Varid{a},(\Varid{l},\Varid{r}))\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{Node}\;(\Varid{a},(\Varid{l}\;[\mskip1.5mu \mskip1.5mu],\Varid{r}\;[\mskip1.5mu \mskip1.5mu])){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{g2}\;(\Varid{a},(\Varid{l},\Varid{r}))\;(\Varid{h}\mathbin{:}\Varid{t})\mid \Varid{h}\equiv \Conid{True}\mathrel{=}\Varid{l}\;\Varid{t}{}\<[E]%
\\
\>[11]{}\hsindent{19}{}\<[30]%
\>[30]{}\mid \Varid{otherwise}\mathrel{=}\Varid{r}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{g2}\;(\Varid{s},(\Varid{l},\Varid{r}))\mathrel{=}\Conid{Fork}\;(\Varid{l},\Varid{r}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment data Bdt a = Dec a  Query (String,(Bdt a, Bdt a)) }{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  nao tenho a certeza se esta bem -> rever}{}\<[E]%
\\
\>[B]{}\Varid{baseBdt}\;\Varid{g}\;\Varid{f}\mathrel{=}\Varid{id}+(\Varid{g}\times(\Varid{f}\times\Varid{f})){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{anaBdt}\;\Varid{g}\mathrel{=}\Varid{inBdt}\comp {}\<[21]%
\>[21]{}(\Varid{recBdt}\;(\Varid{anaBdt}\;\Varid{g}))\comp \Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{navLTree}\mathbin{::}\mathsf{LTree}\;\Varid{a}\to ([\mskip1.5mu \Conid{Bool}\mskip1.5mu]\to \mathsf{LTree}\;\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{navLTree}\mathrel{=}\Varid{cataLTree}\;\alt{\Varid{g1}}{\Varid{g2}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g1}\;\Varid{a}\;\anonymous \mathrel{=}{}\<[19]%
\>[19]{}\Conid{Leaf}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{l},\Varid{r})\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{Fork}\;(\Varid{l}\;[\mskip1.5mu \mskip1.5mu],\Varid{r}\;[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{l},\Varid{r})\;(\Varid{h}\mathbin{:}\Varid{t})\mid \Varid{h}\equiv \Conid{True}\mathrel{=}\Varid{l}\;\Varid{t}{}\<[E]%
\\
\>[9]{}\hsindent{15}{}\<[24]%
\>[24]{}\mid \Varid{otherwise}\mathrel{=}\Varid{r}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{34}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{bnavLTree}\mathrel{=}\Varid{cataLTree}\;\alt{\Varid{g1}}{\Varid{g2}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g1}\;\Varid{a}\;\anonymous \mathrel{=}\Conid{Leaf}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{l},\Varid{r})\;\Conid{Empty}\mathrel{=}\Conid{Fork}\;(\Varid{l}\;\Conid{Empty},\Varid{r}\;\Conid{Empty}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{l},\Varid{r})\;(\Conid{Node}\;(\Varid{b},(\Varid{e},\Varid{d})))\mid \Varid{b}\equiv \Conid{True}\mathrel{=}\Varid{l}\;\Varid{e}{}\<[E]%
\\
\>[9]{}\hsindent{25}{}\<[34]%
\>[34]{}\mid \Varid{otherwise}\mathrel{=}\Varid{r}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment newtype Dist a = D {unD :: [(a,ProbRep)]}}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment pbnavLTree :: LTree a -> ((BTree (Dist Bool)) -> Dist(LTree a))}{}\<[E]%
\\
\>[B]{}\Varid{pbnavLTree}\mathrel{=}\Varid{cataLTree}\;\alt{\Varid{g1}}{\Varid{g2}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g1}\;\Varid{a}\;\anonymous \mathrel{=}\Conid{D}\;[\mskip1.5mu (\Conid{Leaf}\;\Varid{a},\mathrm{1})\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{a},\Varid{b})\;\Conid{Empty}\mathrel{=}(\bind )\;(\Varid{prod}\;(\Varid{a}\;\Conid{Empty})\;(\Varid{b}\;\Conid{Empty}))\;(\Varid{return}\comp \Conid{Fork}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{a},\Varid{b})\;(\Conid{Node}\;(\Varid{c},(\Varid{l},\Varid{r})))\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{final}\leftarrow \Varid{c};\mathbf{if}\;\Varid{final}\;\mathbf{then}\;\Varid{a}\;\Varid{l}\;\mathbf{else}\;\Varid{b}\;\Varid{r}\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{truchet}\mathbin{::}\Conid{Int}\to \Conid{Int}\to \fun{IO}\;(){}\<[E]%
\\
\>[B]{}\Varid{truchet}\;\Varid{x}\;\Varid{y}\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{r}\leftarrow (\Varid{randomTabuleiro}\;\Varid{x}\;\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{display}\;\Varid{janela}\;\Varid{white}\;(\Varid{put}\;(\Varid{fromIntegral}\;(\mathbin{-}\mathrm{40}\mathbin{*}\Varid{x}),\Varid{fromIntegral}\;(\mathbin{-}\mathrm{40}\mathbin{*}\Varid{y}))\;\Varid{r}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{randomTabuleiro}\mathbin{::}\Conid{Int}\to \Conid{Int}\to \fun{IO}\;\Conid{Picture}{}\<[E]%
\\
\>[B]{}\Varid{randomTabuleiro}\;\mathrm{0}\;\anonymous \mathrel{=}\Varid{return}\;(\Conid{Pictures}\;[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{randomTabuleiro}\;\Varid{x}\;\Varid{y}\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{l}\leftarrow (\Varid{randomLinha}\;\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{t}\leftarrow (\Varid{randomTabuleiro}\;(\Varid{x}\mathbin{-}\mathrm{1})\;\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{let}\;\Varid{r}\mathrel{=}\Conid{Pictures}\;((\Varid{put}\;(\mathrm{0},\Varid{fromIntegral}\;(\mathrm{80}\mathbin{*}(\Varid{x}\mathbin{-}\mathrm{1})))\;\Varid{l})\mathbin{:}[\mskip1.5mu \Varid{t}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{return}\;\Varid{r}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{randomLinha}\mathbin{::}\Conid{Int}\to \fun{IO}\;\Conid{Picture}{}\<[E]%
\\
\>[B]{}\Varid{randomLinha}\;\mathrm{0}\mathrel{=}{}\<[18]%
\>[18]{}\Varid{return}\;(\Conid{Pictures}\;[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{randomLinha}\;\Varid{x}\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{l}\leftarrow \Varid{randomLadrilho}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{t}\leftarrow \Varid{randomLinha}\;(\Varid{x}\mathbin{-}\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{let}\;\Varid{r}\mathrel{=}\Conid{Pictures}\;((\Varid{put}\;(\Varid{fromIntegral}\;(\mathrm{80}\mathbin{*}(\Varid{x}\mathbin{-}\mathrm{1})),\mathrm{0})\;\Varid{l})\mathbin{:}[\mskip1.5mu \Varid{t}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{return}\;\Varid{r}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{randomLadrilho}\mathbin{::}\fun{IO}\;\Conid{Picture}{}\<[E]%
\\
\>[B]{}\Varid{randomLadrilho}\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{l}\leftarrow \Varid{permuta}\;[\mskip1.5mu \Varid{truchet1},\Varid{truchet2}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{let}\;\Varid{r}\mathrel{=}\Varid{l}\mathbin{!!}\mathrm{0}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{return}\;\Varid{r}{}\<[E]%
\\[\blanklineskip]%
